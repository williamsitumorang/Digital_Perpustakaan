...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@11/dist/sweetalert2.min.css"> <!-- Tambahkan SweetAlert CSS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
</head>
...
<body>
    <div class="sidebar" id="sidebar">
        ...
        <a href="{{ route('user.dashboard_user') }}" class="sidebar-item">
            <div class="sidebar-icon">
                <i class="fas fa-th-large"></i>
            </div>
            <span>Dashboard</span>
        </a>
        <a href="{{ route('user.data_buku') }}" class="sidebar-item">
            <div class="sidebar-icon">
                <i class="fas fa-cogs"></i>
            </div>
            <span>Data Buku</span>
        </a>
        <a href="{{ route('user.kategori_buku') }}" class="sidebar-item">
            <div class="sidebar-icon">
